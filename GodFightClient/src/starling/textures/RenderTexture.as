...
package starling.textures {
	...
	public class RenderTexture extends Texture {
		...
		public function drawBundled(drawingBlock : Function, antiAliasing : int = 0) : void {
			...
			context.setScissorRectangle(new Rectangle(0, 0, mActiveTexture.width * scale, mActiveTexture.height * scale));
		...
		public override function get width() : Number {
			return mActiveTexture.width;
		}

		/** @inheritDoc */
		public override function get height() : Number {
			return mActiveTexture.height;
		}

		/** @inheritDoc */
		public override function get scale() : Number {
			return mActiveTexture.scale;
		}
